...
class ProductEditPage extends Component
{
    ...
    public function mount(Product $product)
    {
        ...
        $this->name_idn = $product->name_idn;
    ...
    public function resetFields()
    {
        ...
        $this->name_idn = $this->product->name_idn;
    ...
    public function rules()
    {
        return [
            ...
            'name_idn' => "required|string|max:100|unique:products,name_idn,{$this->product->id}",
    ...
    {
        $product = (new ProductService())->edit(product: $this->product, data: $this->validate());

        $this->flash('success', trans('index.edit_success'), [
            'html' => trans('index.product')." - {$product->id} - ".trans('index.edited'),
        ]);
