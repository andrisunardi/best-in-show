...
@if ($imageUrl)
    ...
    <div class="row mt-3">
        <div class="col-6 col-md-auto">
            <x-button.view :class="'btn btn-primary btn-sm w-100'" :href="$imageUrl" :target="'_blank'" />
        </div>

        <div class="col-6 col-md-auto">
            <x-button.download :class="'btn btn-info text-white btn-sm w-100'" :href="$imageUrl" />
        </div>
