    ...
    <div class="card my-3">
        ...
        <div class="card-body">
            <div class="row">
                ...
                @can('Product Trash')
                    <div class="col-6 col-sm-auto mb-3">
                        <x-components::link.trash :href="route('cms.product.trash')" />
                    </div>
                @endcan
            </div>
                            ...
                            <tr wire:key="{{ $product->id }}">
                                ...
                                <td>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        @can('Product View')
                                            <li>
                                                <x-components::link.view :class="'dropdown-item'" :href="route('cms.product.view', [
                                                    'product' => $product->id,
                                                ])" />
                                            </li>
                                        @endcan
                                        @can('Product Clone')
                                            <li>
                                                <x-components::link.clone :class="'dropdown-item'" :href="route('cms.product.clone', [
                                                    'product' => $product->id,
                                                ])" />
                                            </li>
                                        @endcan
                                        @can('Product Edit')
                                            <li>
                                                <x-components::link.edit :class="'dropdown-item'" :href="route('cms.product.edit', [
                                                    'product' => $product->id,
                                                ])" />
                                            </li>
                                        @endcan
                                        @can('Product Active')
                                            <li>
                                                <x-components::link.active :class="'dropdown-item'" :href="route('cms.product.active', [
                                                    'product' => $product->id,
                                                ])"
                                        ...
                                        @can('Product Delete')
                                            <li>
                                                <x-components::link.delete :class="'dropdown-item'" :href="route('cms.product.delete', [
                                                    'product' => $product->id,
                                                ])" />
                                            </li>
                                        @endcan
