    ...
    <div class="input-group">
        <select class="form-select select2" wire:model="search_menu" id="search_menu">
            ...
            <optgroup label="{{ trans('index.my_profile') }}">
                ...
                <option value="cms.profile.activity-log"
                    {{ Route::is('cms.profile.activity-log') ? 'selected' : null }}>
                    {{ trans('index.activity_log') }}
                </option>
                <option value="cms.profile.edit-profile"
                    {{ Route::is('cms.profile.edit-profile') ? 'selected' : null }}>
