                ...
                <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
                    @if ($setting->createdBy)
                        <a draggable="false" target="_blank"
                            href="{{ route('cms.configuration.user.view', ['user' => $setting->createdBy->id]) }}">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
                    @if ($setting->updatedBy)
                        <a draggable="false" target="_blank"
                            href="{{ route('cms.configuration.user.view', ['user' => $setting->updatedBy->id]) }}">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
                        @if ($setting->deletedBy)
                            <a draggable="false" target="_blank"
                                href="{{ route('cms.configuration.user.view', ['user' => $setting->deletedBy->id]) }}">
                ...
                @if ($setting->trashed())
                    @can('Setting Restore')
                        <div class="col-12 col-sm-auto mt-3 mt-sm-0">
                            <x-button.restore :href="route('cms.configuration.setting.restore', [
                                'setting' => $setting->id,
                            ])" />
                        </div>
                    @endcan
                    ...
                    @can('Setting Delete Permanent')
                        <div class="col-12 col-sm-auto mt-3 mt-sm-0">
                            <x-button.delete-permanent :href="route('cms.configuration.setting.delete-permanent', [
                                'setting' => $setting->id,
                            ])" />
                        </div>
                    @endcan
                @else
                    @can('Setting Active')
                        <div class="col-6 col-sm-auto mt-3 mt-sm-0">
                            <x-button.active :href="route('cms.configuration.setting.active', [
                                'setting' => $setting->id,
                    ...
                    @can('Setting Clone')
                        <div class="col-6 col-sm-auto mt-3 mt-sm-0">
                            <x-button.clone :href="route('cms.configuration.setting.clone', [
                                'setting' => $setting->id,
                            ])" />
                        </div>
                    @endcan
                    ...
                    @can('Setting Edit')
                        <div class="col-6 col-sm-auto mt-3 mt-sm-0">
                            <x-button.edit :href="route('cms.configuration.setting.edit', [
                                'setting' => $setting->id,
                            ])" />
                        </div>
                    @endcan
                    ...
                    @can('Setting Delete')
                        <div class="col-6 col-sm-auto mt-3 mt-sm-0">
                            <x-button.delete :href="route('cms.configuration.setting.delete', [
                                'setting' => $setting->id,
                            ])" />
                        </div>
                    @endcan
