            ...
            <div class="row">
                @can('Role Add')
                    <div class="col-6 col-sm-auto mb-3">
                        <x-button.add :href="route('cms.configuration.role.add')" />
                    </div>
                @endcan
            </div>
                    ...
                    <tbody>
                        @forelse ($roles as $role)
                            <tr wire:key="{{ $role->id }}">
                                ...
                                <td class="text-center">
                                    <a draggable="false"
                                        href="{{ route('cms.configuration.permission.index', ['role_id' => $role->id]) }}"
                                        target="_blank">
                                ...
                                <td class="text-center">
                                    <a draggable="false"
                                        href="{{ route('cms.configuration.user.index', ['role_id' => $role->id]) }}"
                                        target="_blank">
                                        {{ $role->users->count() }}
                                    </a>
                                </td>
                                <td>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        @can('Role View')
                                            <li>
                                                <x-button.view :class="'dropdown-item'" :href="route('cms.configuration.role.view', [
                                                    'role' => $role->id,
                                                ])" />
                                            </li>
                                        @endcan
                                        @can('Role Clone')
                                            <li>
                                                <x-button.clone :class="'dropdown-item'" :href="route('cms.configuration.role.clone', [
                                                    'role' => $role->id,
                                                ])" />
                                            </li>
                                        @endcan
                                        @can('Role Edit')
                                            <li>
                                                <x-button.edit :class="'dropdown-item'" :href="route('cms.configuration.role.edit', [
                                                    'role' => $role->id,
                                                ])" />
                                            </li>
                                        @endcan
                                        @can('Role Delete')
                                            <li>
                                                <x-button.delete :class="'dropdown-item'" :href="route('cms.configuration.role.delete', [
                                                    'role' => $role->id,
                                                ])" />
                                            </li>
                                        @endcan
