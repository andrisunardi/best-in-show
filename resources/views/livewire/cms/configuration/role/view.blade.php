        ...
        <div class="card-body">
            <div class="row">
                <div class="col-6 col-sm-auto mb-3">
                    <x-button.back :href="route('cms.configuration.role.index')" />
                </div>
            </div>
            ...
            <div class="row mt-3">
                @can('Role Clone')
                    <div class="col-6 col-sm-auto mt-3 mt-sm-0">
                        <x-button.clone :href="route('cms.configuration.role.clone', [
                            'role' => $role->id,
                        ])" />
                    </div>
                @endcan
                ...
                @can('Role Edit')
                    <div class="col-6 col-sm-auto mt-3 mt-sm-0">
                        <x-button.edit :href="route('cms.configuration.role.edit', [
                            'role' => $role->id,
                        ])" />
                    </div>
                @endcan
                ...
                @can('Role Delete')
                    <div class="col-6 col-sm-auto mt-3 mt-sm-0">
                        <x-button.delete :href="route('cms.configuration.role.delete', [
                            'role' => $role->id,
                        ])" />
                    </div>
                @endcan
