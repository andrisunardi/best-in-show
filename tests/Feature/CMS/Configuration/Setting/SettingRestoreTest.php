...
class SettingRestoreTest extends TestCase
{
    public $setting;
    ...
    public function setUp(): void
    {
        ...
        $this->url = route('cms.configuration.setting.restore', ['setting' => $this->setting->id]);
    }
    ...
    public function test_success(): void
    {
        ...
        $this->assertEquals($this->setting->deleted_at, null);
    ...
    public function test_success_redirect_previous_url_from_view(): void
    {
        ...
        $response = $this->actingAs($this->auth)->get($this->url);
        $response->assertStatus(302);
        $response->assertLocation(env('APP_CMS_URL')."/configuration/setting/view/{$this->setting->id}");
        $response->assertRedirect(env('APP_CMS_URL')."/configuration/setting/view/{$this->setting->id}");
        $response->assertRedirectToRoute('cms.configuration.setting.view', ['setting' => $this->setting->id]);
